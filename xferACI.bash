...
$ cd $HOME/go/src/github.com/joshix/acbuild
towncar:acbuild j$ scp -i .vagrant/machines/default/virtualbox/private_key -P 2222 \
vagrant@127.0.0.1:caddybox/caddy-v0.8.2-linux-amd64.aci ~/Downloads/
